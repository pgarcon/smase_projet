...
globals [
  ...
  nombre_heure_de_pointe ; nombre de persoone en voiture aux heures de pointes
  nombre_heure_creuse ; nombre de personne en voiture aux heures creuses
]
...
to setup
  ...
  ; La polution d'une voiture sur la route en gramme de co2
  set polution_voiture (distance_trajet_moyen * consomation_co2_moyen)
...
to go
  ...
  let heure (ticks / 120000)
  let newHeure (ticks mod 120000)
...
to transmettre_charge
  ...
  set charge max list (charge - charge_tot) 0
end
